 ...
 */
public class BossFragment extends BaseUpFragment {
    private static final String TAG = BossFragment.class.getSimpleName();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        RxBus.get().unregister(BossFragment.class.getSimpleName(), observable);
