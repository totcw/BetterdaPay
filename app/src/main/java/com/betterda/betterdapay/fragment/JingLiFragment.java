 ...
 */
public class JingLiFragment extends BaseUpFragment {
    private static final String TAG = JingLiFragment.class.getSimpleName();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        RxBus.get().unregister(JingLiFragment.class.getSimpleName(), observable);
