 ...
 */
public class DianZhangFragment extends BaseUpFragment {
    private static final String TAG = DianZhangFragment.class.getSimpleName();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        RxBus.get().unregister(DianZhangFragment.class.getSimpleName(), observable);
