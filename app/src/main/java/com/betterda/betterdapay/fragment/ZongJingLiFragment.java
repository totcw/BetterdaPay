 ...
 */
public class ZongJingLiFragment extends BaseUpFragment {
    private static final String TAG = ZongJingLiFragment.class.getSimpleName();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        RxBus.get().unregister(ZongJingLiFragment.class.getSimpleName(), observable);
