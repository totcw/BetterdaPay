...
public class BankData {
    ...
    public  static int getBank(String key) {
        if (bankMap == null) {
            bankMap = new HashMap<>();
            bankMap.put("工商银行", R.mipmap.gongshang);
            bankMap.put("农业银行", R.mipmap.nongye);
            bankMap.put("中国银行", R.mipmap.zhongguo);
            bankMap.put("建设银行", R.mipmap.jianshe);
            bankMap.put("交通银行", R.mipmap.jiaotong);
            bankMap.put("中信银行", R.mipmap.zhongxin);
            bankMap.put("民生银行", R.mipmap.minsheng);
            bankMap.put("兴业银行", R.mipmap.xingye);
            bankMap.put("邮政储蓄银行", R.mipmap.youzheng);
            bankMap.put("浦发银行", R.mipmap.pudong);
            bankMap.put("光大银行", R.mipmap.guangda);
            bankMap.put("招商银行", R.mipmap.zhaoshang);
    ...
    public  static String getBankNo(String key) {
        if (bankNoMap == null) {
            ...
            bankNoMap.put("邮政储蓄银行", "403100000004");
            bankNoMap.put("浦发银行", "310290000013");
            bankNoMap.put("光大银行", "303100000006");
            bankNoMap.put("招商银行", "308584000013");
