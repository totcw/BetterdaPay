...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 标题正常时的颜色
     */
    private static final int COLOR_TEXT_NORMAL = 0x772b2b2b;
    /**
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFf75555;
    private int downX;
    private int downY;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mLinePaint.setColor(Color.parseColor("#f75555"));
        mLinePaint.setStyle(Style.STROKE);
        //直线的宽度
        final float scale = context.getResources().getDisplayMetrics().density;
        mLinePaint.setStrokeWidth((int) (10 * scale + 0.5f));
    ...
    protected void dispatchDraw(Canvas canvas) {
     ...
     //   canvas.drawPath(mPath, mPaint);
        ...
        //画平移的直线
        canvas.drawLine(mLineTranslationX+mTranslationX,getHeight()+1 ,mLineTranslationX+mLineWidth+mTranslationX,getHeight()+1,mLinePaint);
        canvas.restore();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //直线的宽度
        mLineWidth = getScreenWidth() /mTabVisibleCount-1 ;
        mLineTranslationX =0;
    }
        ...
        if (datas != null && datas.size() > 0) {
            ...
            for (String title : mTabTitles) {
               ...
               // addView(generateTextView(title));
                ...
                lp.topMargin = 5;
                lp.bottomMargin = 5;
                view.setBackgroundColor(0x77d6d7dc);
                view.setLayoutParams(lp);

                LinearLayout linearLayout = new LinearLayout(getContext());
                LayoutParams lp2 = new LayoutParams(
                        LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
                lp2.width = getScreenWidth() / mTabVisibleCount;
    ...
    private TextView generateTextView(String text) {
        ...
        LayoutParams lp = new LayoutParams(
                LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        lp.width = getScreenWidth() / mTabVisibleCount-1;
